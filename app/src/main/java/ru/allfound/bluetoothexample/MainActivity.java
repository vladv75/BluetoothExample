...
public class MainActivity extends ListActivity {
    ...
    //generate UUID - http://www.famkruithof.net/uuid/uuidgen
    public final static String UUID = "2e47f21f-b4f7-474c-b7ca-9ca70f04be87";
    ...
    private final ICommunicatorService communicatorService = new ICommunicatorService() {
        @Override
        public ICommunicator createCommunicatorThread(BluetoothSocket socket) {
