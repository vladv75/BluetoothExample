...
public class ClientThread extends Thread {
    ...
    private volatile ICommunicator communicator;

    private final BluetoothSocket socket;
    private BluetoothAdapter bluetoothAdapter;
    private final ICommunicatorService communicatorService;

    public ClientThread(BluetoothDevice device, ICommunicatorService communicatorService) {
    ...
    public synchronized ICommunicator getCommunicator() {
        return communicator;
    }
